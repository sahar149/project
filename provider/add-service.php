<?php
/**
 * Dabberha (دبرها) - Add Service (Provider Panel)
 * Location: provider/add-service.php
 */
...
renderHead(['title' => __('Add New Service') . ' - ' . __('Dabberha')]);
?>
        ...
        <main class="flex-1 p-6 md:p-8 lg:p-10 max-w-4xl mx-auto w-full">
            <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="text-brand-textMuted mt-1"><?php echo __('Fill in the details to publish a new service listing'); ?></p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 sm:p-8 shadow-soft border border-brand-border">
                <form method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" class="w-full px-4 py-2.5 rounded-xl border border-brand-border bg-brand-surface text-sm font-medium focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary" placeholder="<?php echo __('e.g., Expert Plumbing Installation'); ?>" required>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4" class="w-full px-4 py-2.5 rounded-xl border border-brand-border bg-brand-surface text-sm font-medium focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary" placeholder="<?php echo __('Describe what is included in this service...'); ?>" required></textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" step="0.01" name="price" id="price" class="w-full px-4 py-2.5 rounded-xl border border-brand-border bg-brand-surface text-sm font-medium focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary" placeholder="0.00" required>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="price_type" id="price_type" class="w-full px-4 py-2.5 rounded-xl border border-brand-border bg-brand-surface text-sm font-medium focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary" required>
                                <option value="fixed"><?php echo __('Fixed Price'); ?></option>
                                <option value="hourly"><?php echo __('Hourly Rate'); ?></option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="pt-4 border-t border-brand-border flex items-center justify-end gap-3">
                        ...
                        <button type="submit" class="bg-brand-primary hover:bg-brand-primaryHover text-white px-6 py-2.5 rounded-xl text-sm font-bold transition-all shadow-xs flex items-center gap-2">
                            ...
                            <span><?php echo __('Save Service'); ?></span>
                        </button>
                    </div>
                </form>
            </div>
